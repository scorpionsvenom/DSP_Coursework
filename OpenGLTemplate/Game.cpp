...
Game::Game()
{
	...
	previousPosition = m_spaceShipPosition;
}
...
void Game::Initialise() 
{
	...
	m_t = 0.0f;
	m_spaceShipPosition = glm::vec3(0.0f, 0.0f, 0.0f);
	m_spaceShipOrientation = glm::mat4(0.0f);
	...
	m_pCube->Create("resources\\textures\\dirtpile01.jpg", 100.0f, 30.0f, 1.0f);
	...
	m_pAudio->CreateWall(glm::vec3(0.0f, 15.0f, 50.0f), 100.0f, 30.0f);
}
